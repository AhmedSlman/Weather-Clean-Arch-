...
import 'package:mina_farid_clean_arch/weather/data/repository/weather_repo.dart';
...
import 'package:mina_farid_clean_arch/weather/domain/usecases/get_weather_py_city.dart';

void main() async {
  BaseRemoteDataSource baseRemoteDataSource = RemoteDataSource();
  BaseWeatherRepo baseWeatherRepo = WeatherRepo(baseRemoteDataSource);
  Weather weather =
      await GetWeatherByCityName(baseWeatherRepo).execute("cairo");
  print(weather);
  runApp(const MyApp());
}
